...
tableextension 55002 "APA MADCS Prod. Order Componen" extends "Prod. Order Component"
{
    fields
    {
        field(55000; "APA MADCS Quantity"; Decimal)
        {
        ...
        field(55001; "APA MADCS Lot No."; Code[50])
        {
        ...
        field(55002; "APA MADCS Verified"; Boolean)
        {
        ...
        field(55003; "APA MADCS Original Line No."; Integer)
        {
        ...
        field(55005; "APA MADCS Consumed Quantity"; Decimal)
        {
